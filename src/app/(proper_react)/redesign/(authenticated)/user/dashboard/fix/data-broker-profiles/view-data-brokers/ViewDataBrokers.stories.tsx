...
const brokerOptions = {
  ...
  unresolved_few: "With a few unresolved scan results",
  unresolved_many: "With many unresolved scan results",
...
const ViewWrapper = (props: ViewWrapperProps) => {
  ...
  if (props.brokers !== "no-scan") {
    ...
    if (props.brokers === "unresolved_few") {
      scanData.results = mockedFewUnresolvedScanResults;
    }
    if (props.brokers === "unresolved_many") {
...
const meta: Meta<typeof ViewWrapper> = {
  title: "Pages/Guided resolution/2. Scan results",
